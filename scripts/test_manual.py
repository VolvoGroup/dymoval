#  -*- coding: utf-8 -*-
"""
Created on Srn Jul 10 23:35:31 2022
...
if fixture_type == "SISO" or fixture_type == "MISO":
    sim1_labels = "my_y1"
sim1_values = vs._validation_dataset._dataset["OUTPUT"].values + np.random.rand(
    len(vs._validation_dataset._dataset["OUTPUT"].values), 1
)
...
if fixture_type == "SISO" or fixture_type == "MISO":
    sim2_labels = "your_y1"
sim2_values = vs._validation_dataset._dataset["OUTPUT"].values + np.random.rand(
    len(vs._validation_dataset._dataset["OUTPUT"].values), 1
)
